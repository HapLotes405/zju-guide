...
每门课程拥有 8 个信息分区：课程身份、为什么学（前置/后续/误区）、课前预习、课中跟课、期末复习、老师评价、资源区（含 CC98 一键跳转）、图谱区（依赖树）。

### 投稿审核系统（解决「散落资料到知识图谱」断裂）

同学投稿学习资料 → 管理员审核通过/驳回 → 资源关联到课程公开可见。支持 7 种资源类型（电子书、笔记、真题回忆、博客、CC98 帖子、工具模板、其他），区分 4 个学习阶段（课前/课中/期末/全部）。
